...
class NextEpisodeToAir(
        ...
        companion object CREATOR : Parcelable.Creator<NextEpisodeToAir> {
                override fun createFromParcel(parcel: Parcel): NextEpisodeToAir {
                        return NextEpisodeToAir(parcel)
                }
